...
class Schmitke_Configurator_Settings_V2 {
    ...
    private static function sanitize_design($settings, $defaults) {
        ...
        return [
            ...
            'accordionToggleBg' => sanitize_hex_color($src['accordionToggleBg'] ?? '') ?: ($defaults['accordionToggleBg'] ?? '#111111'),
            'accordionToggleIcon' => sanitize_hex_color($src['accordionToggleIcon'] ?? '') ?: ($defaults['accordionToggleIcon'] ?? '#ffffff'),
            ...
            'accordionToggleBgOpen' => sanitize_hex_color($src['accordionToggleBgOpen'] ?? '') ?: ($defaults['accordionToggleBgOpen'] ?? '#1f6feb'),
