...
class Schmitke_Configurator_Settings_V2 {
    ...
    private static function sanitize_design($settings, $defaults) {
        ...
        return [
            ...
            'accordionToggleBg' => sanitize_hex_color($src['accordionToggleBg'] ?? '') ?: ($defaults['accordionToggleBg'] ?? '#f2f2f2'),
            'accordionToggleIcon' => sanitize_hex_color($src['accordionToggleIcon'] ?? '') ?: ($defaults['accordionToggleIcon'] ?? '#111111'),
            'accordionToggleBgHover' => sanitize_hex_color($src['accordionToggleBgHover'] ?? '') ?: ($defaults['accordionToggleBgHover'] ?? '#000000'),
            'accordionToggleIconHover' => sanitize_hex_color($src['accordionToggleIconHover'] ?? '') ?: ($defaults['accordionToggleIconHover'] ?? '#ffffff'),
            'accordionToggleBgFocus' => sanitize_hex_color($src['accordionToggleBgFocus'] ?? '') ?: ($defaults['accordionToggleBgFocus'] ?? '#f2f2f2'),
            'accordionToggleIconFocus' => sanitize_hex_color($src['accordionToggleIconFocus'] ?? '') ?: ($defaults['accordionToggleIconFocus'] ?? '#111111'),
            'accordionToggleBgOpen' => sanitize_hex_color($src['accordionToggleBgOpen'] ?? '') ?: ($defaults['accordionToggleBgOpen'] ?? '#111111'),
            'accordionToggleIconOpen' => sanitize_hex_color($src['accordionToggleIconOpen'] ?? '') ?: ($defaults['accordionToggleIconOpen'] ?? '#ffffff'),
            'accordionToggleBgOpenFocus' => sanitize_hex_color($src['accordionToggleBgOpenFocus'] ?? '') ?: ($defaults['accordionToggleBgOpenFocus'] ?? '#111111'),
            'accordionToggleIconOpenFocus' => sanitize_hex_color($src['accordionToggleIconOpenFocus'] ?? '') ?: ($defaults['accordionToggleIconOpenFocus'] ?? '#ffffff'),
            'focusOutlineColor' => sanitize_hex_color($src['focusOutlineColor'] ?? '') ?: ($defaults['focusOutlineColor'] ?? '#111111'),
    ...
    private static function sanitize_option_entries($options) {
        ...
        foreach ($options as $opt) {
            ...
            $result[] = [
                ...
                'order' => isset($opt['order']) ? intval($opt['order']) : (count($result) + 1),
